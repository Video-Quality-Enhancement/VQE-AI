...
def video_output(resultQ: Queue, request_id: str):
    ...
    # from enhanced_video_details['shape'] convert to string 144p, 240p, 360p, 480p, 720p, 1080p, 2K, 4K, 8K
...
def main(url: str, request_id: str):
    ...
    # return enhanced_video_details['url'], "SUCCESS", "Video enhanced successfully"
