...
from enhance import main_480p

def enhance_480p_video(video_enhance_request: VideoEnhanceRequest) -> EnhancedVideoResponse:
    print(video_enhance_request)
    
    try:
        enhanced_video_url, enhanced_video_quality, status, statusMessage = main_480p.main(video_enhance_request.videoUrl, video_enhance_request.requestId)
